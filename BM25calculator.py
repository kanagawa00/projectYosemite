...
我无法查到确切证据表明维谢格拉德集团收受奥塞码头的补贴，但是法国外交部想必对这一系列操作乐见其成，甚至予以推波助澜。这都是合乎逻辑的。毕竟，波兰、捷克、再加上最近转向背离德国路线的奥地利，在东方实现了对德国的全包围。这几国也长期扮演德国工业配套的角色（捷克尚有大量英国资本）。如果能对他们加以拉拢，对于牵制德国的经济扩张政策，意义是非常明显的。
...
jieba.add_word("小协约国",100,"nr")
jieba.add_word("维谢格拉德集团",100,"n")
